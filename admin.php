                                            ...
                                            <?php
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="uploads/<?php echo $row['adminImage'] ?>" width="50px" height="50px" alt=""></td>
                                ...
                                <div class="">
                                    <div class="d-flex align-items-center justify-content-center mb-2">
                                        <div class="position-relative">
                                            <img id="previewImage" src="./img/profile.jpg   " alt="Admin Image" width="150px" height="150px" class="rounded-circle">
