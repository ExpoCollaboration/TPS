...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `product` SET `productName`='$productName',`productPrice`='$productPrice',`productSauce`='$productSauce',`productFlavor`='$productFlavor',`productOutStock`='$productOutStock' WHERE id = $id";
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="./tableProduct.php">Tables</a></li>
                                ...
                                <div class="">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="productSauce" value="<?php echo $row['productSauce'] ?>">
                                        </div>

                                        <div class="mb-3">
                                            <div class="form-label">Flavor:</div>
                                            <input type="text" class="form-control" name="productFlavor" value="<?php echo $row['productFlavor'] ?>">
                                        </div>
